...
export default function ListaLivros(props: any) {
  const [livros, definirLivros] = useState<any[]>([]);
  ...
  function atualizarPesquisa(evento: any) {
    setPesquisa({ ...pesquisa, termo: evento.target.value });
  }

  const efetuarPesquisa = async (e: any) => {
    e.preventDefault();
